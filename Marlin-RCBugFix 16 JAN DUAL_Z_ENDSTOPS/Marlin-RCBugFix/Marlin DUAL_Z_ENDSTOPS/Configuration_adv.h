...
//  #define CASE_LIGHT_PIN 26          // can be defined here or in the pins_XXX.h file for your board
...
#define Z_DUAL_STEPPER_DRIVERS
  ...
  #define Z_DUAL_ENDSTOPS
    ...
    #define Z_DUAL_ENDSTOPS_ADJUSTMENT  -11  // use M666 command to determine this value
  #endif
