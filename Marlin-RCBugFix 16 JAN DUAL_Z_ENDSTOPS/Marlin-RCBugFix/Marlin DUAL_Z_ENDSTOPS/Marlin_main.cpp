 ...
 * M124 - Immediately stop all motors & kill all planned moves
...
inline void gcode_G28() {
  ...
  #if PLANNER_LEVELING
     bool abl_was_enabled_BOB = false;
    #if HAS_ABL
      abl_was_enabled_BOB = planner.abl_enabled;
    #endif
    set_bed_leveling_enabled(false);
  #endif
 ...
 * M124: Immediately stop all motors & kill all planned moves
 */
inline void gcode_M124() { stepper.immediate_stop();}
  ...
  switch (command_code) {
    ...
    case 'M': switch (codenum) {
      ...
      case 121: // M121: Disable endstops
        gcode_M121();
        break;
      case 124: // M124: Immediately stop all motors
        gcode_M124();
        break;
