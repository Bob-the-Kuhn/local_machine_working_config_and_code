...
//#define Bob_LINEAR
//#define Bob_3_POINT
//#define Bob_CNC_inductive
//#define Bob_switching
//#define Bob_UBL_TEST
#define Bob_UBL_print
//#define Bob_UBL_TEST_ULTISHIELD

#if ENABLED(Bob_CNC_MAX)
  // Travel limits after homing (units are in mm) for CNC
  ...
  #define TEMP_SENSOR_0 998  // always 25C
  #define TEMP_SENSOR_BED 998  // always 25C
  #define Z_MIN_PROBE_ENDSTOP_INVERTING true  // short end mill to ground
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0   // Z offset: -below +above  [the nozzle]  // negative means the probe activated with the nozel above the bed
...
#elif ENABLED(Bob_3D_PRINT)
  // Travel limits after homing (units are in mm) for 3D printer
  #define X_MIN_POS -65        // G28 sets X position to this value after homing
  #define Y_MIN_POS -60       // G28 sets Y position to this value after homing
  #define Z_MIN_POS 0        // G28 sets Z position to this value after homing
...
//  #define TEMP_SENSOR_BED 998  // always 25C
  ...
  #define Z_PROBE_END_SCRIPT "G0 X0 Y0 Z50"
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.80   // Z offset: -below +above  [the nozzle]  // negative means the probe activated with the nozel above the bed
  #define BLTOUCH
  #define GRID_MAX_POINTS_X 9
  #define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 8)
  #define X_HOME_BUMP_MM 5
...
//  #define AUTO_BED_LEVELING_BILINEAR
  ...
  #define TEMP_SENSOR_0 998  // always 25C
  #define TEMP_SENSOR_BED 998  // always 25C
  #define Z_PROBE_END_SCRIPT "G0 X0 Y0 Z10"
...
#elif ENABLED(Bob_UBL_print)
  // Travel limits after homing (units are in mm) for CNC
  #define X_MIN_POS -50        // G28 sets X position to this value after homing
  #define Y_MIN_POS -70       // G28 sets Y position to this value after homing
  #define Z_MIN_POS 0        // G28 sets Z position to this value after homing
...
//  #define AUTO_BED_LEVELING_BILINEAR
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 32  // X offset: -left  +right  [of the nozzle]
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -27  // Y offset: -front +behind [the nozzle]
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.46   // Z offset: -below +above  [the nozzle]  // negative means the probe activated with the nozel above the bed
  #define GRID_MAX_POINTS_X 3
  #define X_HOME_BUMP_MM 5
  #define Y_HOME_BUMP_MM 5
  #define Z_HOME_BUMP_MM 2
  ...
  #define UBL_MESH_MAX_X 260
  #define UBL_MESH_MIN_Y 0
  #define UBL_MESH_MAX_Y 260
...
#elif ENABLED(Bob_UBL_TEST_ULTISHIELD)
  // Travel limits after homing (units are in mm) for CNC
  #define X_MIN_POS 0        // G28 sets X position to this value after homing
  #define Y_MIN_POS 0        // G28 sets Y position to this value after homing
  #define Z_MIN_POS 0        // G28 sets Z position to this value after homing
...
//  #define AUTO_BED_LEVELING_BILINEAR
  ...
  #define RIGHT_PROBE_BED_POSITION 390
  #define FRONT_PROBE_BED_POSITION 10
  #define BACK_PROBE_BED_POSITION 480
  #define TEMP_SENSOR_0 999  // always 25C
  #define TEMP_SENSOR_BED 998  // always 25C
  #define Z_PROBE_END_SCRIPT "G0 X0 Y0 Z10"
  #define X_PROBE_OFFSET_FROM_EXTRUDER 0 // X offset: -left  +right  [of the nozzle]
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0  // Y offset: -front +behind [the nozzle]
...
//    #define Z_PROBE_SPEED_SLOW 100  
  ...
  #define TEMP_SENSOR_BED 998  // always 25C
  #define Z_MIN_PROBE_ENDSTOP_INVERTING true  // short end mill to ground
  #define Z_PROBE_END_SCRIPT "G0 X0 Y0 Z100"
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0   // Z offset: -below +above  [the nozzle]  // negative means the probe activated with the nozel above the bed
  #define GRID_MAX_POINTS_X 9
...
#elif ENABLED(Bob_CNC_inductive)
  // Travel limits after homing (units are in mm) for CNC
  #define X_MIN_POS 0        // G28 sets X position to this value after homing
  #define Y_MIN_POS 0        // G28 sets Y position to this value after homing
  #define Z_MIN_POS 0        // G28 sets Z position to this value after homing
  ...
  #define AUTO_BED_LEVELING_BILINEAR
  #define LEFT_PROBE_BED_POSITION 75
  #define RIGHT_PROBE_BED_POSITION 400
  #define FRONT_PROBE_BED_POSITION 0
  #define BACK_PROBE_BED_POSITION 450
  #define TEMP_SENSOR_0 998  // always 25C
  #define TEMP_SENSOR_BED 998  // always 25C
